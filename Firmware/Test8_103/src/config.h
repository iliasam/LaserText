...
//This value defines length of visible line in bytes (*8 to get pixels in line)
#define BYTES_IN_LINE   32 

#define DEFAULT_PHASE_SHIFT   12

// Number of drawn lines, must be < BLDC_STEP_COUNT
// See also "line_conv_table" init !
#define VERT_LINE_NUMBER                24
...
// THESE VARIABLES MUST BE ADJUSTED!
